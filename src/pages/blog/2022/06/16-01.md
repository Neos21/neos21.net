...
なお、ハングルについては以前「ハングルを特定する正規表現」を見つけていて、コレがこの Unicode ブロックにおける_「Hangul Syllables ハングル音節文字」(U+AC00 ～ U+D7AF)_ にほぼ相当することが分かった。
...
Unicode の界隈でよく **CJK**、「CJK 統合漢字」という言葉を耳にしていた。中国語・日本語・朝鮮語で使われる漢字を_ひとまとめ_にした符号表である。
