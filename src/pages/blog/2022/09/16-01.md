...
とはいっても Nodist は自動的に最新の Node.js バージョンも拾い上げてくれるので今までは別に不自由なく Nodist でよかったのだが、最近 Nodist を使って _Node.js v18 系_にアップデートしたところ、Node.js が正常に動作しなかった。いや、正しくは **npm v8 系**が正常にインストールできないようである。
