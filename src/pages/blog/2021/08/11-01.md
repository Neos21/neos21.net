...
ちょっと **C#** でも勉強してみるか？でも Node.js や Python の拡張には _C++_ が使われているよなぁ。どっちがどういう言語なんだったっけ？

ということで調べてみた。

## C# と C++ の違い

**C#** と _C++_ の違いを、PowerShell や .NET Framework、そして Windows API との関係性から整理してみる。
...
というワケで、VSCode 拡張機能を利用して、**C#** と _C++_ の基本的な開発環境をちょっと整えてみようと思う。
