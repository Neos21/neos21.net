...
ベゼルの差で、2枚のモニタの外見上のサイズがほとんど変わらないのが良い。ただ、解像度が違うため、Windows 10 の設定でディスプレイ位置を調整しても、見た目どおりにマウスを行き来できないところがちょっとアレ。ただまぁ、自分はそもそも**デュアルモニタでほとんど作業しない**ので、あまり困ることはない。_基本はモニタ1枚で作業するのが好き_なのだ。動画を見ながら作業したいとか、そういう時だけ BenQ のモニタの電源を ON にして使う感じで運用している。
