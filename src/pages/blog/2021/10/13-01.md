...
- エンティティ
  ...
  - DDD においては、O/R マッパーの話は出てこなくて、__一意に特定・識別できるモデル__を示す
...
_並のプログラマのスキルじゃ、Service クラスを適宜作って分かるレベルまでしか理解できんって。_なんでもかんでも小さな Value Object や細かい Model を作っても、やたら見通し悪いなーと思うだけで、ついていけんって。
