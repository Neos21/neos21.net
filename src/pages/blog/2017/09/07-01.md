...
例えば _cordova-plugin-googlemaps_ の V1 系の場合。
...
他にも、_cordova-plugin-bluetoothle_ でペリフェラル端末の準備をする処理。
...
Cordova プラグインの大多数がこのようなコールバック地獄になりやすい API になっているのは、Cordova 本体がネイティブと連携する、__`cordova.exec()`__ メソッドの作りにある。
