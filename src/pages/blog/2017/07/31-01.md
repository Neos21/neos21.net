...
今回の例では、Appium と Protractor の起動は、Gulp タスクとして定義している。__`gulpfile.js` はコチラ。__

- [AngularJSCordovaAppium/gulpfile.js at master · Neos21/AngularJSCordovaAppium · GitHub](https://github.com/Neos21/AngularJSCordovaAppium/blob/master/gulpfile.js)
