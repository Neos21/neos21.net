...
会社で使っている _MacBookAir 13インチ Early 2015_ を自宅に持って帰っていたので、自分の **MacBookPro 13インチ Early 2015** と外観を比べてみた。
...
_左が Air_・**右が Pro**。(部屋が汚いので周りを黒く塗り潰しています)
...
ついでに、_Air は JIS (日本語) キーボード_、**Pro は US (英語) キーボード**だったので、キー配列についても比較してみた。
