...
_Ionic_ (アイオニック) は、Cordova を拡張するフレームワークで、_AngularJS_ を組み合わせることでより柔軟な開発が可能になるもの。AngularJS には **ngCordova** というモジュールがあり、Cordova プラグインを AngularJS のモジュールとしてラップしているのでより扱いやすかったりする。
