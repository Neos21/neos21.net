...
> Xcodeの_Product / Scheme / Edit Scheme...メニュー（`⌘+<`）_の、左側のカラムが_Run_、上の選択肢がArguments、で表示される_Environment Variables_に、  
> __Nameを「`OS_ACTIVITY_MODE`」、Valueを「disable」に設定__してやることでほとんど出なくなってくれる。ありがたい。
