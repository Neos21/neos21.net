...
**Heroku (ヘロク)** という PaaS (Platform as a Service) がある。Debian・Ubuntu 系の Linux 仮想環境に、Ruby on Rails や Node.js 製のアプリをデプロイして公開できるサービスだ。DB に PostgreSQL などが使える。_無料枠_もあり、開発者がお試しで使うには十分な環境。
