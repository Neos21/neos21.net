...
どういうワケか、iPhone Safari で見る時だけこのファイルが上手く読み込まれず、レイアウトが崩れることがあったので、試しに__フォールバック処理__を組み込んでみることにした。
