...
仮想通貨の界隈で**「Faucet」**と呼ばれるサービスが存在する。Faucet (フォーセット) とは「蛇口」のことで、_一定時間経過してから「ビットコインください！」ボタンを押すとビットコインがもらえる_、というサービスだ。
...
今回は、_CoinPot_ というマイクロウォレットサービスと、その連携 Faucet サービスである **[Moon Bitcoin](http://moonbit.co.in/?ref=f9b82c79d5bf)** を紹介しよう。
