...
以前、_Anker Astro E5 第2世代_という古いモバブーを使って、ラズパイ4と Elecrow 5インチ液晶をバッテリー駆動させることができた。
...
色々探して自分が選んだのは、__Power Add Aries I__ という 10,000mAh のモノ。値段が安くて、_1,599円_だった。
...
Anker Astro E5 と比べてみたが、__本体サイズは Aries I の方が大きい。__重量は 399g ほどあるらしく、コンパクトさに欠ける。コレは完全に失敗した。安いだけで小さく・軽くなかった。
...
__この状態で、動作は問題なく行えた。__Astro E5 より大きく・重たくて残念だが、ラズパイ4の駆動には使えたのが良かった。
