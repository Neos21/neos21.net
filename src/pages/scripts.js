...
// PV カウンタ
fetch('https://ct.neos21.net/ct/pv?id=1&referrer=' + (document.referrer ?? '') + '&landing=' + location.href + '&title=' + (document.title ?? '')).catch(error => console.error('Failed To Update Counter', error));
