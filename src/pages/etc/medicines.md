...
- ザズベイ (ズラノロン)
  - めっちゃ効いた
  - 14日間の服用でうつ病を改善する薬。14日間のあとは最低6週間の経過観察 (薬を飲まない) を設け、効き目が足りなければ追加で14日間飲む感じ
  - 神経の興奮を鎮める GABA の働きを高めることで効果を出す
- レキサルティ
  - セロトニン、ドーパミン分泌に寄与する <dfn title="セロトニン・ドパミン・アクティビティ・モジュレータ">SDAM</dfn>
  - トリンテリックスの効果増強・調整的な併用をされることがある
  - エビリファイを改良したもので、セロトニンにより強く働き、ドーパミンの作用はマイルドになっているらしい
- トリンテリックス
  - セロトニンを増やし、セロトニン受容体に働きかける <dfn title="セロトニン再取り込み阻害・セロトニン受容体調節剤">S-RIM</dfn>
  - 頭が回らない、思考のモヤモヤ、認知機能などに効果期待
- デュロキセチン
  - セロトニン、ノルアドレナリンを促し、痛みや落ち込みを和らげる SNRI
  - 効果が出るまで2～4週間かかる
  - 意欲低下にはセルトラリンよりもコチラの方がオススメ

- ジェイゾロフト (セルトラリン)
  - <dfn title="選択的セロトニン再取り込み阻害薬">SSRI</dfn>。25mg・50mg・100mg がある
  - 飲み忘れると少し動悸を感じる。落ち着く作用はある模様。効果が出るまで2～4週間はかかるもの
...
- メリスロン
  - めまいの頓服
- トリアゾラム
  - ハルシオン。睡眠導入剤。幻覚、夢と現実の区別が付きにくくなる場合がある
- デキストロメトルファン
  - 咳止め
- ベルソムラ
  - 寝付きを良くする
